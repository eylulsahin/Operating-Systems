...
public class Philosopher extends Thread {
	...
	//take_forks, put_forks and test functions taken from recitation 5 slides
	...
	void put_forks(int i) throws InterruptedException {
	...
	public void run() {
		...
		// Barrier
		try {
			int wait_for = new Random().nextInt(10000);
			this.sleep(wait_for);
		}
		catch (InterruptedException e){
			e.printStackTrace();
